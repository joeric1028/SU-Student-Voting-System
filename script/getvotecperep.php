    ...
    <body>
        <table class="w3-table-all w3-hoverable">
            ...
            <?php
                ...
                $q = intval($_GET['q']);
                $result = mysqli_query($con,"SELECT * FROM user INNER JOIN course ON course_idcourse = idcourse INNER JOIN college ON college_idcollege = idcollege WHERE candidatetype ='Computer Engineering Representative' AND idcollege ='$q' AND candidateyear ='$currentyear';");
                if($result != FALSE)
                {
